...
export const SectionSelect = () => {
	...
	return (
		<div className="settings-section-wrapper">
			...
			<select name="parameters" className="section-parameters" value={selectedSection} onChange={handleSection}>
				{SECTIONS.map((section) => {
					return (
						<option key={section} value={section} className="section-parameters">
							{section}
						</option>
					);
				})}
